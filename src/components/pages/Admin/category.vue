<template>
<div>
	<modal modalHeading="Add New Category" :cond="showingAddTrue" @modalClose="showingAddTrue = false">
		<table class="table">
	...
	<tr>
					...
					<td>
						<textarea type="text" id="newCatName" v-model="newCategory.description" placeholder="Write sort description">
					</td>				
				</tr>
	...
	<button class="addBtn fright" @click="showingAddTrue = true">Add New</button>
	<div class="clear"></div>
</div>
</template>
<script>
